...
var uniNavBar = function uniNavBar() {__webpack_require__.e(/*! require.ensure | components/uni-nav-bar/index */ "components/uni-nav-bar/index").then((function () {return resolve(__webpack_require__(/*! @/components/uni-nav-bar/index.vue */ 81));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('uni-nav-bar', uniNavBar);_vue.default.config.productionTip = false;_App.default.mpType = 'app';var app = new _vue.default(_objectSpread({}, _App.default));_vue.default.use(_httpInterceptor.default, app);_vue.default.use(_httpApi.default, app);
createApp(app).$mount();
